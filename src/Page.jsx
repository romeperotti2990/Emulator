    ...
    async function handleRomClick(rom) {
        ...
        if (isSafe) {
            ...
            if (platform === 'all' || platform === '*') {
                const romPlatform = (rom.platform || '').toLowerCase();
                if (romPlatform.startsWith('gb')) core = 'gb';
                else if (romPlatform.includes('gba')) core = 'gba';
                else if (romPlatform.includes('nes')) core = 'nes';
                else if (romPlatform.includes('snes')) core = 'snes';
                else if (romPlatform.includes('n64')) core = 'n64';
                    ...
                    <div className="mt-8 w-full flex justify-center">
                        <div className="w-full max-w-4xl h-[720px] border-2 border-gray-700 rounded-lg bg-black overflow-hidden">
                            <iframe
                                ...
                                title="Emulator"
                                allow="cross-origin-isolated" // This is still required!
                            />
                        </div>
                    </div>
